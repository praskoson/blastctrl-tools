...
import { METADATA_PROGRAM_ID } from "utils/spl/common";
...
const metadataUrl = "https://arweave.net/EQ0VYkf-u48pzgpEmPLH0jBQG0GHZd5JMBKWzwYQCOk";
...
function get(res: NextApiResponse<GetResponse>) {
  ...
  res.status(200).json({
    label: "Greed NFT",
    icon: "https://i.imgur.com/nIl0azd.png",
  });
}
...
async function buildTransaction(account: PublicKey) {
  ...
  const lamportsForMintAccount = await getMinimumBalanceForRentExemptMint(connection);
    ...
    },
    {
      createMetadataAccountArgsV3: {
        data: {
          ...
          name: "The $GREED Experiment", // on-chain name
          symbol: "GREED", // on-chain symbol
          uri: metadataUrl, // off-chain metadata
