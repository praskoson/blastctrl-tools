...
export default function NftFaucet() {
  const [selected, setSelected] = useState<(typeof plans)[number] | undefined>(undefined);

  return (
    <div className="mx-auto w-[min(100%,theme(screens.sm))] p-4 outline outline-red-600">
      <div className="pb-4">
        <h1 className="pb-1 font-display text-2xl font-bold">Get a random NFT</h1>
        <p className="text-zinc-500">
          Mint an NFT/Asset for yourself using any of the supported standards. Intended to be used
          for development testing purposes, but if you just want to get an NFT, be my guest 😉
        </p>
      </div>
