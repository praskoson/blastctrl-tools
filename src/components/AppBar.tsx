...
export const AppBar: FC = (props) => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex flex-row bg-primary text-neutral-content shadow-lg">
        ...
        <div className="hidden md:navbar-center md:inline">
          <div className="flex items-stretch">
            ...
            <Link href="/collections">
              <a className="btn btn-ghost rounded-btn btn-sm">Collections</a>
            </Link>
            <Link href="/arweave">
              <a className="btn btn-ghost rounded-btn btn-sm">Arweave</a>
            </Link>
            <Link href="/update-nft">
              <a className="btn btn-ghost rounded-btn btn-sm">Update NFT</a>
            </Link>
          </div>
        </div>
