...
export const Footer = () => {
  return (
    <footer className="footer grid-cols-2 items-center bg-neutral p-6 text-neutral-content sm:grid-cols-3">
      ...
      <div className="hidden grid-flow-col gap-4 pr-2 text-center sm:block sm:justify-self-end">
        <div>
          <p className="cursor-default text-base font-light text-white ">Built with</p>
          <a
            rel="noreferrer"
